...
RawReadsBoxPlot <- function(path.prefix) {
  ...
  png(paste0(path.prefix, "RNAseq_results/results/raw_reads/gene/Box_plot.png"),  width = 600, height = 600)
  ...
  print(p1)
  dev.off()
  png(paste0(path.prefix, "RNAseq_results/results/raw_reads/transcript/Box_plot.png"),  width = 600, height = 600)
