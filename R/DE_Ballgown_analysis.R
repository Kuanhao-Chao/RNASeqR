...
BallgownTranscriptRelatedPlot <- function(path.prefix){
  ...
  cex.before <- par("cex")
  par(cex = 0.7)
  hist(count, breaks=50, col="bisque4", xlab="Transcripts per gene", main="Distribution of Transcript Count per Gene", cex.main=1.14)
  ...
  cex.before <- par("cex")
  par(cex = 0.7)
  hist(full_table$length, breaks=50, xlab="Transcript length (bp)", main="Distribution of Transcript Lengths", col="steelblue", cex.main=1.14)
