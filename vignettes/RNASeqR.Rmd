---
title: "RNASeqR : RNA-Seq differential expression analysis based on one independent variable analysis"
...
RNASeqR is an user-friendly R-based tool for running case-control study(two group) RNA-Seq analysis pipeline. The six main steps in this package is *Environment Setup*,  *Quality Assessment*, *Quality Trimming*, *Reads Alignment and Quantification*, *Gene-level Differential Expression Analysis* and *Functional Analysis.*
